...
from pr_baby_app_esclave.babyfut import ON_RASP
...
#		18: 'escape'
	...
	def __init__(self, sendThread, camera):
		...
		if ON_RASP:
			...
			self.goalThread = GoalThread(self, sendThread, **Input._GoalPins)
			self.camera = camera
...
class GoalThread(GPIOThread):
	def __init__(self, parent, send, pin_trig, pin_echo):
		GPIOThread.__init__(self)
		self.parent = parent
